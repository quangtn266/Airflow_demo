...
def _latest_only(**context):
    ...
    lef_window = context["dag"].following_schedule(context["execution_date"])
    right_window = context["dag"].following_schedule(lef_window)

    if not lef_window < now <= right_window:
