...
class MovielensRatingSensor(BaseSensorOperator):
    """
    ...
    # pylint: disable = unsed-argument, missing-docstring.
    def poke(self, context):
        ...
        try:
            ...
            # This means that there are records for the given periods, which we indicate
            ...
            # any record. This means that there are no ratings for the time period,
